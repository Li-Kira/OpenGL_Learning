...
const char* WINDOW_TITLE = "09_StencilTest";
...
int main() {
    ...
    Shader shader("res/shader/09_stencilTest.vert", "res/shader/09_stencilTest.frag");
    Shader singleColorShader("res/shader/09_stencilTest.vert", "res/shader/09_stencilTest_singleColor.frag");

    // std::string modelPath = "res/model/backpack.obj";
    // Model ourModel(modelPath);

    unsigned int cubeTexture = TextureUtils::loadTexture("res/texture/marble.jpg");
    unsigned int floorTexture = TextureUtils::loadTexture("res/texture/metal.png");
    shader.use(); 
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        singleColorShader.setMat4("u_ModelMatrix", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
        model = glm::scale(model, glm::vec3(scale, scale, scale));
