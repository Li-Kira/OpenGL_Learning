...
const char* WINDOW_TITLE = "17a_AntiAliasing_MSAA";
...
int main() {
    ...
    Shader shader("res/shader/17a_antiAliasing.vert", "res/shader/17a_antiAliasing.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Checkbox("Show MSAA", &isShowMSAA);
        ImGui::End();
        ...
        model = glm::rotate(model, 30.0f, glm::vec3(0.4f, 0.6f, 0.8f));
