...
const char* WINDOW_TITLE = "21_NormalMapping";
...
int main() {
    ...
    unsigned int diffuseMap = TextureUtils::loadTexture("res/texture/brickwall.jpg", true, GL_REPEAT, GL_REPEAT);
    unsigned int normalMap = TextureUtils::loadTexture("res/texture/brickwall_normal.jpg", true, GL_REPEAT, GL_REPEAT);

    Shader shader("../21_normalMapping.vert", "../21_normalMapping.frag");
