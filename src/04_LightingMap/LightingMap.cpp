...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "04_LightingMap", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("res/shader/04_lightingMap.vert", "res/shader/04_lightingMap.frag");
...
void ShowFPS(GLFWwindow* window, float fps) {
    std::string title = "04_LightingMap - FPS: " + std::to_string(static_cast<int>(fps));
