...
const char* WINDOW_TITLE = "20a_Shadow_Mapping_Depth";
...
int main() {
    ...
    Shader simpleDepthShader("res/shader/20a_shadowMappingDepth.vert", "res/shader/20a_shadowMappingDepth.frag");
    Shader debugDepthQuad("res/shader/20a_debugQuad.vert", "res/shader/20a_debugQuad.frag");

    unsigned int woodTexture = TextureUtils::loadTexture(
