...
const char* WINDOW_TITLE = "Debug Scene";
...
int main() {
    ...
    Shader shader("res/shader/20c_shadowMapping.vert", "res/shader/20c_shadowMapping.frag");
    Shader simpleDepthShader("res/shader/20c_shadowMappingDepth.vert", "res/shader/20c_shadowMappingDepth.frag");
    Shader debugDepthQuad("res/shader/20c_debugQuadDepth.vert", "res/shader/20c_debugQuadDepth.frag");
