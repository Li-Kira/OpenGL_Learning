...
const char* WINDOW_TITLE = "25a_Deferred_Shading";
...
int main() {
    ...
    // Shader info
    // -------------
    Shader geometryPassShader("../25a_gBuffer.vert", "../25a_gBuffer.frag");
    Shader lightingShader("../25a_deferredShading.vert", "../25a_deferredShading.frag");
    Shader lightingBoxShader("../25a_deferredLightBox.vert", "../25a_deferredLightBox.frag");
    Shader debugShader("../25a_fboDebug.vert", "../25a_fboDebug.frag");
