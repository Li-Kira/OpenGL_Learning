...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "05d_LightCasters_SpotSoft", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("res/shader/05d_spotSoft.vert", "res/shader/05d_spotSoft.frag");
...
void ShowFPS(GLFWwindow* window, float fps) {
    std::string title = "05d_LightCasters_SpotSoft - FPS: " + std::to_string(static_cast<int>(fps));
