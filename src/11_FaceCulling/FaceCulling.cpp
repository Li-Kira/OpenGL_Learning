...
const char* WINDOW_TITLE = "11_FaceCulling";
...
int main() {
    ...
    Shader shader("res/shader/11_faceCulling.vert", "res/shader/11_faceCulling.frag");
    ...
    unsigned int transparentTexture = TextureUtils::loadTexture("res/texture/window.png", false, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE);
