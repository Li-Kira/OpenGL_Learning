...
const char* WINDOW_TITLE = "18_Advanced_Lighting";
...
int main() {
    ...
    unsigned int floorTexture = TextureUtils::loadTexture("res/texture/wood.png", true, GL_REPEAT, GL_REPEAT);

    Shader shader("res/shader/18_advancedLighting.vert", "res/shader/18_advancedLighting.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Begin("Advanced Lighting Shader");
        ImGui::Checkbox("Is Blinn", &blinn);
        ImGui::End();
