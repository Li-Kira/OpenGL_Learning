...
const char* WINDOW_TITLE = "25b_Deferred_Shading_Volumes_Fake";
...
int main() {
    ...
    // Shader info
    // -------------
    Shader geometryPassShader("../25b_gBuffer.vert", "../25b_gBuffer.frag");
    Shader lightingShader("../25b_deferredShading.vert", "../25b_deferredShading.frag");
    Shader lightingBoxShader("../25b_deferredLightBox.vert", "../25b_deferredLightBox.frag");
    Shader debugShader("../25b_fboDebug.vert", "../25b_fboDebug.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::SliderFloat("Linear", &linear, 0.0f, 5.0f);
