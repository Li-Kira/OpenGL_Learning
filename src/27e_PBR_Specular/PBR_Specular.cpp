...
const char* WINDOW_TITLE = "27e_PBR_Specular";
...
int main() {
    ...
    // Shader info
    // -------------
    Shader pbrShader("../27e_pbr.vert", "../27e_pbr.frag");
    Shader equirectangularToCubemapShader("../27e_cubemap.vert", "../27e_Equirectangular_to_Cubemap.frag");
    Shader irradianceShader("../27e_cubemap.vert", "../27e_irradianceConvolution.frag");
    Shader prefilterShader("../27e_cubemap.vert", "../27e_prefilter.frag");
    Shader brdfShader("../27e_brdf.vert", "../27e_brdf.frag");
    Shader backgroundShader("../27e_background.vert", "../27e_background.frag");
