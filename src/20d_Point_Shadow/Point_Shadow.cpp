...
const char* WINDOW_TITLE = "20d_Point_Shadow";
...
int main() {
    ...
    Shader shader("res/shader/20d_pointShadow.vert", "res/shader/20d_pointShadow.frag");
    Shader simpleDepthShader("res/shader/20d_pointShadowDepth.vert", "res/shader/20d_pointShadowDepth.frag", "res/shader/20d_pointShadowDepth.geom");
