...
const char* WINDOW_TITLE = "13a_CubeMap_Environment";
...
int main() {
    ...
    Shader shader("res/shader/13a_cubeMap.vert", "res/shader/13a_cubeMap.frag");
    Shader skyboxShader("res/shader/13a_skybox.vert", "res/shader/13a_skybox.frag");
    ...
    // unsigned int skyboxCubemapTexture = loadSkyboxCubemap(faces);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        skyboxShader.setMat4("u_ViewMatrix", view);
        skyboxShader.setMat4("u_ProjectionMatrix", projection);
        // skybox cube
        glBindVertexArray(skyboxVAO);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTexture);
