...
const char* WINDOW_TITLE = "24_Bloom";
...
int main() {
    ...
    // Shader info
    // -------------
    Shader shader("../24_bloom.vert", "../24_bloom.frag");
    Shader lightShader("../24_bloom.vert", "../24_lightBox.frag");
    Shader blurShader("../24_blur.vert", "../24_blur.frag");
    Shader bloomFinalShader("../24_bloomFinal.vert", "../24_bloomFinal.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Begin("Bloom");
        ImGui::Checkbox("is Bloom", &isBloom);  // Add rotation checkbox
        ImGui::SliderFloat("Explosure", &exposure, 0.0f, 10.0f);
        ImGui::End();
        ...
        bloomFinalShader.setInt("bloom", isBloom);
