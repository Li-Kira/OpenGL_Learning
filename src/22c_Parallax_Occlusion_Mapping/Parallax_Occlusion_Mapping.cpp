...
const char* WINDOW_TITLE = "22c_Parallax_Occlusion_Mapping";
...
int main() {
    ...
    unsigned int diffuseMap = TextureUtils::loadTexture("res/texture/toy_box_diffuse.png", true, GL_REPEAT, GL_REPEAT);
    unsigned int normalMap = TextureUtils::loadTexture("res/texture/toy_box_normal.png", true, GL_REPEAT, GL_REPEAT);
    unsigned int heightMap  = TextureUtils::loadTexture("res/texture/toy_box_disp.png", true, GL_REPEAT, GL_REPEAT);

    Shader shader("../22c_parallaxOcclusionMapping.vert", "../22c_parallaxOcclusionMapping.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Begin("Parallax_Mapping");
        ImGui::SliderFloat("Height Scale", &heightScale, 0.0f, 5.0f);
        ImGui::Checkbox("Rotate Quad", &rotateQuad);  // Add rotation checkbox
        ImGui::End();
