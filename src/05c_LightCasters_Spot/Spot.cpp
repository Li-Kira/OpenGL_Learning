...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "05c_LightCasters_Spot", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("res/shader/05c_spot.vert", "res/shader/05c_spot.frag");
...
void ShowFPS(GLFWwindow* window, float fps) {
    std::string title = "05c_LightCasters_Spot - FPS: " + std::to_string(static_cast<int>(fps));
