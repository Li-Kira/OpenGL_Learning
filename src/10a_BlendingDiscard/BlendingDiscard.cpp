...
const char* WINDOW_TITLE = "10a_BlendingDiscard";
...
int main() {
    ...
    Shader shader("res/shader/10a_blendingDiscard.vert", "res/shader/10a_blendingDiscard.frag");
    ...
    unsigned int transparentTexture = TextureUtils::loadTexture("res/texture/grass.png", false, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE);
