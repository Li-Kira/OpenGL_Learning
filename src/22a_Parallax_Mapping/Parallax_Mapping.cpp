...
const char* WINDOW_TITLE = "22a_Parallax_Mapping";
...
int main() {
    ...
    unsigned int diffuseMap = TextureUtils::loadTexture("res/texture/bricks2.jpg", true, GL_REPEAT, GL_REPEAT);
    unsigned int normalMap = TextureUtils::loadTexture("res/texture/bricks2_normal.jpg", true, GL_REPEAT, GL_REPEAT);
    unsigned int heightMap  = TextureUtils::loadTexture("res/texture/bricks2_disp.jpg", true, GL_REPEAT, GL_REPEAT);

    Shader shader("../22_parallaxMapping.vert", "../22_parallaxMapping.frag");
