...
const char* WINDOW_TITLE = "27d_PBR_Irradiance";
...
int main() {
    ...
    // Shader info
    // -------------
    Shader pbrShader("../27d_pbr.vert", "../27d_pbr.frag");
    Shader equirectangularToCubemapShader("../27d_cubemap.vert", "../27d_Equirectangular_to_Cubemap.frag");
    Shader irradianceShader("../27d_cubemap.vert", "../27d_irradianceConvolution.frag");
    Shader backgroundShader("../27d_background.vert", "../27d_background.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Logger::log(Logger::Level::Error, "SCR_WIDTH: ", SCR_WIDTH)
        // Logger::log(Logger::Level::Error, "SCR_HEIGHT: ", SCR_HEIGHT)
        // Logger::log(Logger::Level::Error, "fbWidth: ", fbWidth)
        // Logger::log(Logger::Level::Error, "fbHeight: ", fbHeight)
