...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "02_Lighting", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("res/shader/02_basicLighting.vert", "res/shader/02_basicLighting.frag");
...
void ShowFPS(GLFWwindow* window, float fps) {
    std::string title = "02_Lighting - FPS: " + std::to_string(static_cast<int>(fps));
