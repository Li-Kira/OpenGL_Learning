...
const char* WINDOW_TITLE = "13_CubeMap";
...
int main() {
    ...
    Shader shader("res/shader/13_cubeMap.vert", "res/shader/13_cubeMap.frag");
    Shader skyboxShader("res/shader/13_skybox.vert", "res/shader/13_skybox.frag");
