...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "05b_LightCasters_Point", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("res/shader/05b_point.vert", "res/shader/05b_point.frag");
...
void ShowFPS(GLFWwindow* window, float fps) {
    std::string title = "05b_LightCasters_Point - FPS: " + std::to_string(static_cast<int>(fps));
