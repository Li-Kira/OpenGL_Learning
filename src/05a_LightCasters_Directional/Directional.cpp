...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "05a_LightCasters_Directional", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("res/shader/05a_directional.vert", "res/shader/05a_directional.frag");
...
void ShowFPS(GLFWwindow* window, float fps) {
    std::string title = "05a_LightCasters_Directional - FPS: " + std::to_string(static_cast<int>(fps));
