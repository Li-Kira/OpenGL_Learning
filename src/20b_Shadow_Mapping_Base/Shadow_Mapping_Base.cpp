...
const char* WINDOW_TITLE = "20b_Shadow_Mapping_Base";
...
int main() {
    ...
    Shader shader("res/shader/20b_shadowMapping.vert", "res/shader/20b_shadowMapping.frag");
    Shader simpleDepthShader("res/shader/20b_shadowMappingDepth.vert", "res/shader/20b_shadowMappingDepth.frag");
    Shader debugDepthQuad("res/shader/20b_debugQuad.vert", "res/shader/20b_debugQuad.frag");
